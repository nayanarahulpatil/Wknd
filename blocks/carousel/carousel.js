...
function createSlide(row, slideIndex, carouselId) {
  ...
  //   newAnchor.classList.add('text-slide');
  //   newAnchor.title = clickhere;
  //   newAnchor.href = '/blogs/blog1';
  //   newAnchor.target = '_blank'
  //   newAnchor.appendChild(document.createTextNode(clickhere));
  //   slide.append(newAnchor)
